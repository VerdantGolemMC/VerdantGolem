...
//!
//! This crate provides everything needed to write a VerdantGolem server plugin compiled
...
//!
//! ```rust,ignore
//! use verdantgolem_plugin_api::{Plugin, PluginMetadata, Context, register_plugin, permissions::permissions};
//!
//! struct MyPlugin;
//!
...
/// The trait that every VerdantGolem plugin must implement.
///
...
/// Registers the provided type as a VerdantGolem plugin.
///
