...
///
/// ```rust,ignore
/// use verdantgolem_plugin_api::command::{CommandSuggestion, CommandSuggestions, SuggestionRequest};
/// use verdantgolem_plugin_api::commands::CommandSuggestionHandler;
/// use verdantgolem_plugin_api::Server;
///
...
///     fn suggest(
///         &self,
///         _sender: verdantgolem_plugin_api::command::CommandSender,
///         _server: Server,
