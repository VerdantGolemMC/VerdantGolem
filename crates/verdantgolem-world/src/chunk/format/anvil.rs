...
pub const SUBREGION_BITS: u8 = verdantgolem_util::math::ceil_log2(REGION_SIZE as u32);
...
impl From<verdantgolem_config::chunk::Compression> for Compression {
    fn from(value: verdantgolem_config::chunk::Compression) -> Self {
        // :c
        match value {
            verdantgolem_config::chunk::Compression::GZip => Self::GZip,
            verdantgolem_config::chunk::Compression::ZLib => Self::ZLib,
            verdantgolem_config::chunk::Compression::LZ4 => Self::LZ4,
            verdantgolem_config::chunk::Compression::Custom => Self::Custom,
        }
    }
}
...
mod tests {
    ...
    use verdantgolem_config::{AdvancedConfiguration, advanced_config, override_config_for_testing};
