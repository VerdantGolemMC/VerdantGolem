...
use verdantgolem_data::tag::Block::MINECRAFT_LEAVES;
...
pub enum ChunkParsingError {
    ...
    FailedReadStatus(verdantgolem_nbt::Error),
...
pub enum ChunkSerializingError {
    ...
    ErrorSerializingChunk(verdantgolem_nbt::Error),
}
...
mod tests {
    ...
    use verdantgolem_data::{Block, block_properties::has_random_ticks};
