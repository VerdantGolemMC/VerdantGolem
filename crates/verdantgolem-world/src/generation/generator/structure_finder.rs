...
use verdantgolem_util::math::{floor_div, position::BlockPos};
...
pub fn find_nearest_structure_start(
    ...
    target_structures: &[verdantgolem_data::structures::StructureKeys],
    max_search_radius: i32,
    ...
    use verdantgolem_data::structures::Structure;
