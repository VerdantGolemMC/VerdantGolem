...
pub static PLACED_FEATURES: LazyLock<
    HashMap<verdantgolem_data::placed_feature::PlacedFeature, PlacedFeature>,
> = LazyLock::new(build_placed_features);

pub enum PlacedFeatureWrapper {
    Direct(PlacedFeature),
    Named(verdantgolem_data::placed_feature::PlacedFeature),
}
...
pub enum Feature {
    Named(verdantgolem_data::configured_feature::ConfiguredFeature),
...
impl PlacedFeature {
    pub fn generate_in_proto_chunk(
        ...
        feature_name: verdantgolem_data::placed_feature::PlacedFeature,
    ...
    pub fn generate<T: GenerationCache>(
        ...
        min_y: i8,
        height: u16,
        feature_name: verdantgolem_data::placed_feature::PlacedFeature, // This placed feature
        random: &mut RandomGenerator,
        pos: BlockPos,
    ) -> bool {
...
impl ConditionalPlacementModifier for BlockFilterPlacementModifier {
    fn should_place<T: GenerationCache>(
        &self,
        block_registry: &dyn WorldPortalExt,
        _feature: verdantgolem_data::placed_feature::PlacedFeature,
        chunk: &T,
...
impl ConditionalPlacementModifier for BiomePlacementModifier {
    fn should_place<T: GenerationCache>(
        &self,
        _block_registry: &dyn WorldPortalExt,
        this_feature: verdantgolem_data::placed_feature::PlacedFeature,
        chunk: &T,
        _random: &mut RandomGenerator,
        pos: BlockPos,
    ) -> bool {
...
pub const fn all_placed_feature_names() -> &'static [&'static str] {
    verdantgolem_data::placed_feature::PlacedFeature::all_names()
}
include!("../../../../verdantgolem-data/src/generated/placed_features_generated.rs");
