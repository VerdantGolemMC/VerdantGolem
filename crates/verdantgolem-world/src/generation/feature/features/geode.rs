...
use verdantgolem_data::{Block, BlockDirection, BlockId, BlockState, BlockStateId};
...
impl GeodeFeature {
    ...
    pub fn generate<T: GenerationCache>(
        ...
        _min_y: i8,
        _height: u16,
        _feature_name: verdantgolem_data::placed_feature::PlacedFeature,
                ...
                for dir in &BlockDirection::all() {
                    ...
                    if is_air || is_water {
                        ...
                        let dir_name = match dir {
                            verdantgolem_data::BlockDirection::Up => "up",
                            verdantgolem_data::BlockDirection::Down => "down",
                            verdantgolem_data::BlockDirection::North => "north",
                            verdantgolem_data::BlockDirection::South => "south",
                            verdantgolem_data::BlockDirection::East => "east",
                            verdantgolem_data::BlockDirection::West => "west",
                        };
