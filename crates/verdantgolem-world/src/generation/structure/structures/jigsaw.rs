...
pub enum PoolElementKind {
    ...
    List(Vec<Self>),
    Feature(verdantgolem_data::placed_feature::PlacedFeature),
}
    ...
    fn into_element(self) -> Option<(PoolElementKind, JigsawProjection)> {
        match self {
            ...
            Self::Feature {
                ...
                verdantgolem_data::placed_feature::PlacedFeature::from_name(feature)
...
impl PoolElementKind {
    ...
    pub fn get_shuffled_jigsaw_blocks(
        ...
        random: &mut verdantgolem_util::random::RandomGenerator,
    ) -> Vec<JigsawBlock> {
        match self {
            Self::Single { template, .. } => {
            ...
            Self::Feature(_) => vec![JigsawBlock {
                ...
                facing: verdantgolem_util::BlockDirection::Down,
                up: verdantgolem_util::BlockDirection::South,
...
impl PoolElement {
    #[must_use]
    pub const fn feature(&self) -> Option<verdantgolem_data::placed_feature::PlacedFeature> {
        match self.kind {
...
pub struct JigsawBlock {
    ...
    pub facing: verdantgolem_util::BlockDirection,
    pub up: verdantgolem_util::BlockDirection,
...
impl JigsawBlock {
    ...
    pub fn from_template_block(
        ...
        let facing = match facing_part {
            "south" => verdantgolem_util::BlockDirection::South,
            "east" => verdantgolem_util::BlockDirection::East,
            "west" => verdantgolem_util::BlockDirection::West,
            "up" => verdantgolem_util::BlockDirection::Up,
            "down" => verdantgolem_util::BlockDirection::Down,
            _ => verdantgolem_util::BlockDirection::North,
        };

        let up = match up_part {
            "north" => verdantgolem_util::BlockDirection::North,
            "south" => verdantgolem_util::BlockDirection::South,
            "east" => verdantgolem_util::BlockDirection::East,
            "west" => verdantgolem_util::BlockDirection::West,
            "down" => verdantgolem_util::BlockDirection::Down,
            _ => verdantgolem_util::BlockDirection::Up,
        };
    ...
    pub fn can_attach(
        source: &Self,
        target_facing: verdantgolem_util::BlockDirection,
        target_name: &str,
    ) -> bool {
    ...
    fn place(
        ...
        self.element
            .for_each_template(|_name, processor_list, legacy, template| {
                ...
                let placement_origin = verdantgolem_util::math::vector3::Vector3::new(
...
pub struct JigsawGenerator {
    ...
    pub pool_aliases: &'static [verdantgolem_data::structures::PoolAliasBinding],
}
...
impl JigsawGenerator {
    ...
    pub const fn with_pool_aliases(
        mut self,
        aliases: &'static [verdantgolem_data::structures::PoolAliasBinding],
    ) -> Self {
...
impl StructureGenerator for JigsawGenerator {
    fn get_structure_position(
        ...
        let structure = context
            .structure_key
            .map(|key| verdantgolem_data::structures::Structure::get(&key));
...
mod tests {
    ...
    fn ancient_city_builds_a_multi_piece_graph() {
        ...
        let context = StructureGeneratorContext {
            ...
            min_y: -64,
            height_sampler: None,
            structure_key: Some(verdantgolem_data::structures::StructureKeys::AncientCity),
        };
    ...
    fn pillager_outpost_builds_the_vanilla_jigsaw_graph() {
        ...
        let world_gen = crate::generation::get_world_gen(
            verdantgolem_util::world_seed::Seed(SEED as u64),
            verdantgolem_data::dimension::Dimension::OVERWORLD,
            false,
            Vec::new(),
            String::new(),
        );
        ...
        let context = StructureGeneratorContext {
            ...
            structure_key: Some(verdantgolem_data::structures::StructureKeys::PillagerOutpost),
        };
