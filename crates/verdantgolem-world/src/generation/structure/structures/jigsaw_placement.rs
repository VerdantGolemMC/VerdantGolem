...
impl PoolAliasLookup {
    ...
    pub fn from_bindings(
        bindings: &[verdantgolem_data::structures::PoolAliasBinding],
    ...
    fn add_binding(
        &mut self,
        binding: &verdantgolem_data::structures::PoolAliasBinding,
        random: &mut RandomGenerator,
    ) {
        use verdantgolem_data::structures::PoolAliasBinding;
        match binding {
...
pub const fn rotate_direction(
    dir: verdantgolem_util::BlockDirection,
    rotation: Rotation,
) -> verdantgolem_util::BlockDirection {
    use verdantgolem_util::BlockDirection;
    match rotation {
        Rotation::None => dir,
