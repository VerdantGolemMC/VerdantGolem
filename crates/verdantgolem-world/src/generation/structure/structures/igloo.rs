        ...
        for block in &self.template.blocks {
                ...
                && let Some(nbt) = &block.nbt
            {
                ...
                if mode == "DATA" && metadata == "chest" {
                    ...
                    let mut chest_nbt = verdantgolem_nbt::compound::NbtCompound::new();
            ...
            if block_entity_nbt.is_some() || block_entity_id.is_some() {
                ...
                let mut placed_nbt = verdantgolem_nbt::compound::NbtCompound::new();
...
impl StructurePieceBase for IglooPiece {
    ...
    fn place(
        ...
        let height = chunk.get_top_y(
            &verdantgolem_util::HeightMap::WorldSurfaceWg,
            entrance_pos.x,
            entrance_pos.z,
        );
