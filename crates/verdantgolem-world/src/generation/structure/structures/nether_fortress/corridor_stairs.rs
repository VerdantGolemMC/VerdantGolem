...
use verdantgolem_util::{BlockDirection, math::block_box::BlockBox, random::RandomGenerator};
...
impl StructurePieceBase for CorridorStairsPiece {
    ...
    fn place(
        ...
        let fence = |north: bool, south: bool| {
            ...
            props.north = north;
            props.south = south;
            verdantgolem_data::BlockState::from_id(props.to_state_id(&Block::NETHER_BRICK_FENCE))
        };
