...
//!
//! ```ignore
//! use verdantgolem_world::generation::structure::template::{TemplateCache, TemplatePiece};
//! use verdantgolem_data::Rotation;
//!
...
use verdantgolem_data::Mirror;
use verdantgolem_data::Rotation;
use verdantgolem_nbt::{compound::NbtCompound, tag::NbtTag};
use verdantgolem_util::math::vector3::Vector3;
use verdantgolem_util::random::{RandomImpl, hash_block_pos, legacy_rand::LegacyRand};
...
pub fn place_template(
    ...
    chunk_box: Option<&verdantgolem_util::math::block_box::BlockBox>,
) {
...
pub fn place_template_with_options(
    ...
    for block in &template.blocks {
        ...
        if skip_air && state.id.to_block_id() == verdantgolem_data::Block::AIR.id {
            continue;
        }
        ...
        let final_block = verdantgolem_data::Block::from_id(state.id.to_block_id());
