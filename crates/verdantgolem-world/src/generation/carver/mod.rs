...
use verdantgolem_data::block_state::BlockState;
use verdantgolem_data::carver::{CANYON, CAVE, CAVE_EXTRA_UNDERGROUND, NETHER_CAVE};
use verdantgolem_data::carver::{CarverAdditionalConfig, CarverConfig};
use verdantgolem_data::chunk_gen_settings::MaterialRule;
...
impl CarverBlockIds {
    ...
    pub fn new() -> Self {
        Self {
            air: verdantgolem_data::Block::AIR.default_state,
            cave_air: verdantgolem_data::Block::CAVE_AIR.default_state,
            lava: verdantgolem_data::Block::LAVA.default_state,
            dirt: verdantgolem_data::Block::DIRT.default_state,
            grass_block: verdantgolem_data::Block::GRASS_BLOCK.default_state,
            mycelium: verdantgolem_data::Block::MYCELIUM.default_state,
        }
    }
}
...
fn get_large_feature_seed(seed: u64, chunk_x: i32, chunk_z: i32) -> u64 {
    let mut random = verdantgolem_util::random::legacy_rand::LegacyRand::from_seed(seed);
...
fn schedule_fluid_tick_for_state(
    ...
    if state.id == verdantgolem_data::Block::WATER.default_state.id {
        chunk.schedule_fluid_tick(x, y, z, &Fluid::WATER);
    } else if state.id == verdantgolem_data::Block::LAVA.default_state.id {
...
mod tests {
    ...
    use verdantgolem_data::chunk_gen_settings::{
