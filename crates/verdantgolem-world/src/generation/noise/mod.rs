...
use verdantgolem_data::{Block, BlockState, chunk_gen_settings::GenerationShapeConfig};
use verdantgolem_util::{math::vector3::Vector3, random::xoroshiro128::XoroshiroSplitter};
...
impl<'a> ChunkNoiseGenerator<'a> {
    ...
    pub fn new(
        ...
        >,
        affected_box: Option<verdantgolem_util::math::block_box::BlockBox>,
    ) -> Self {
