...
pub fn write_weather(level_folder: &Path, data: &WeatherData) -> Result<(), WorldInfoError> {
    ...
    verdantgolem_nbt::nbt_compress::write_gzip_compound_tag(root, BufWriter::new(file))
...
pub fn write_game_rules(
    ...
    verdantgolem_nbt::nbt_compress::write_gzip_compound_tag(compound, file)
        .map_err(|e| WorldInfoError::SerializationError(e.to_string()))
}
...
pub fn write_world_clocks(
    ...
    verdantgolem_nbt::nbt_compress::write_gzip_compound_tag(root, file)
        .map_err(|e| WorldInfoError::SerializationError(e.to_string()))
}
