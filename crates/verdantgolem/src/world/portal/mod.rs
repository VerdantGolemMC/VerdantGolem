...
use verdantgolem_data::block_properties::HorizontalAxis;
        ...
        match self {
            ...
            Self::Nether => {
                ...
                match entity_type.id {
                    id if id == verdantgolem_data::entity::EntityType::PLAYER.id => (current_world
                            ...
                            current_level.get_player_by_id(caller.get_entity().entity_id)
                        {
                            match player.client.as_ref() {
                                crate::net::ClientPlatform::Java(client) => {
                                    if let Ok(data) = client.serialize_packet(&verdantgolem_protocol::java::client::play::CGameEvent::new(
                                        verdantgolem_protocol::java::client::play::GameEvent::WinGame,
                                        1.0,
                                    )) {
                                ...
                                crate::net::ClientPlatform::Bedrock(client) => {
                                    if let Ok(data) = client.serialize_packet(
                                        &verdantgolem_protocol::bedrock::client::CShowCredits {
