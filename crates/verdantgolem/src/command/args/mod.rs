...
use verdantgolem_data::advancement::Advancement;
...
pub enum Arg<'a> {
    ...
    Item(&'a str),
    ItemPredicate(&'a str),
    ResourceLocation(verdantgolem_util::identifier::Identifier),
    Block(&'a str),
    ...
    TeamColor(verdantgolem_util::text::color::NamedColor),
    HexColor(u32),
}
