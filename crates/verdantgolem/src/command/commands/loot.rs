...
fn insert_into_inventory(
    inventory: &dyn verdantgolem_world::inventory::Inventory,
    mut stack: verdantgolem_data::item_stack::ItemStack,
    ...
    fn execute(&self, context: &CommandContext) -> CommandExecutorResult {
        ...
        match self.source {
            Source::Loot => {
                ...
                let chest_table =
                    verdantgolem_data::chest_loot_table::get_chest_loot_table(&formatted_key);
            ...
            Source::Mine { has_tool } => {
                ...
                if let Some(loot_table) = &block.loot_table {
                    let tool_item = if has_tool {
                        ...
                        verdantgolem_data::item::Item::from_registry_key(key)
                    } else {
                        None
                    };
