    ...
    fn execute(
        ...
        if success {
            sender.send_message(TextComponent::translate_cross(
                verdantgolem_data::translation::java::COMMANDS_SETBLOCK_SUCCESS,
                verdantgolem_data::translation::bedrock::COMMANDS_SETBLOCK_SUCCESS,
                [
            ...
            Err(CommandError::CommandFailed(TextComponent::translate_cross(
                verdantgolem_data::translation::java::COMMANDS_SETBLOCK_FAILED,
                verdantgolem_data::translation::bedrock::COMMANDS_SETBLOCK_FAILED,
                [],
            )))
        }
    }
