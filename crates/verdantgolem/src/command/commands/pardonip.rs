    ...
    fn execute(
        ...
        let Ok(ip) = IpAddr::from_str(target) else {
            return Err(CommandError::CommandFailed(TextComponent::translate_cross(
                verdantgolem_data::translation::java::COMMANDS_PARDONIP_INVALID,
                verdantgolem_data::translation::bedrock::COMMANDS_UNBANIP_INVALID,
                [],
            )));
        };
            ...
            .map_or_else(
                || {
                    Err(CommandError::CommandFailed(TextComponent::translate_cross(
                        verdantgolem_data::translation::java::COMMANDS_PARDONIP_FAILED,
                        verdantgolem_data::translation::java::COMMANDS_PARDONIP_FAILED,
                        [],
                    )))
                },
                |idx| {
                    ...
                    sender.send_message(TextComponent::translate_cross(
                        verdantgolem_data::translation::java::COMMANDS_PARDONIP_SUCCESS,
                        verdantgolem_data::translation::bedrock::COMMANDS_UNBANIP_SUCCESS,
