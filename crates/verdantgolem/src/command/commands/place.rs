...
use verdantgolem_data::placed_feature::PlacedFeature as PlacedFeatureKey;
use verdantgolem_data::structures::{Structure, StructureKeys, StructureType};
use verdantgolem_data::translation;
use verdantgolem_data::{Block, BlockStateId, Mirror, Rotation};
use verdantgolem_util::identifier::Identifier;
use verdantgolem_util::math::block_box::BlockBox;
use verdantgolem_util::math::position::BlockPos;
use verdantgolem_util::math::vector3::Vector3;
use verdantgolem_util::random::hash_block_pos;
use verdantgolem_util::text::TextComponent;
use verdantgolem_world::generation::proto_chunk::ProtoChunk;
use verdantgolem_world::world::{BlockAccessor, WorldPortalExt};
...
use verdantgolem_world::generation::feature::configured_features::CONFIGURED_FEATURES;
use verdantgolem_world::generation::feature::placed_features::{Feature, PLACED_FEATURES};
use verdantgolem_world::generation::structure::structures::StructureGeneratorContext;
use verdantgolem_world::generation::structure::structures::jigsaw::{
    PoolElementStructurePiece, place_pool_element_templates,
};
use verdantgolem_world::generation::structure::structures::jigsaw_placement::{
    DimensionPadding, JigsawPlacement, LiquidSettings, MaxDistance, PoolAliasLookup,
};
use verdantgolem_world::generation::structure::template::BlockPlacer;
...
use verdantgolem_util::random::legacy_rand::LegacyRand;
...
impl WorldPortalExt for CommandBlockRegistry {
    ...
    fn spawn_mobs_for_chunk_generation(
        ...
        _biome: &'static verdantgolem_data::biome::Biome,
        _chunk_x: i32,
        _chunk_z: i32,
    ) {
    }
...
impl CommandExecutor for PlaceTemplateExecutor {
    fn execute(&self, context: &CommandContext) -> CommandExecutorResult {
        ...
        let template_name = template_name
            ...
            .to_string();
        let Some(template) =
            verdantgolem_world::generation::structure::template::get_template(&template_name)
        else {
            return Err(
        ...
        verdantgolem_world::generation::structure::template::place_template(
            &mut placer,
            &template,
            block_pos.0,
            (0, 0),
