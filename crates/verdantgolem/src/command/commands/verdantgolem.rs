...
const NAMES: [&str; 3] = ["verdantgolem", "version", "ver"];

const DESCRIPTION: &str = "Display information about VerdantGolem.";
        ...
        msg = msg.add_child(
            TextComponent::text(github_translation)
                .click_event(ClickEvent::OpenUrl {
                    url: Cow::from("https://github.com/VerdantGolemMC/VerdantGolem"),
                })
                .hover_event(HoverEvent::show_text(TextComponent::text(
