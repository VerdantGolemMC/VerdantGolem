...
use verdantgolem_protocol::codec::recipe::DynamicRecipe;
use verdantgolem_protocol::java::client::play::CRecipeBookAdd;
...
fn get_recipe_id(recipe: &DynamicRecipe) -> String {
    match recipe {
        DynamicRecipe::Crafting(crafting) => match crafting {
            verdantgolem_protocol::codec::recipe::OwnedCraftingRecipe::Shaped {
                recipe_id,
                result,
                ..
            }
            | verdantgolem_protocol::codec::recipe::OwnedCraftingRecipe::Shapeless {
                recipe_id,
                result,
                ..
        ...
        DynamicRecipe::Cooking(cooking) => match cooking {
            verdantgolem_protocol::codec::recipe::OwnedCookingRecipeType::Smelting(r)
            | verdantgolem_protocol::codec::recipe::OwnedCookingRecipeType::Blasting(r)
            | verdantgolem_protocol::codec::recipe::OwnedCookingRecipeType::Smoking(r)
            | verdantgolem_protocol::codec::recipe::OwnedCookingRecipeType::CampfireCooking(r) => {
                r.recipe_id.clone()
            }
        },
    }
