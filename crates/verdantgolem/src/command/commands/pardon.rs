    ...
    fn execute(
        ...
        for target in targets {
            ...
            if let Some(idx) = idx {
                ...
                sender.send_message(TextComponent::translate_cross(
                    verdantgolem_data::translation::java::COMMANDS_PARDON_SUCCESS,
                    verdantgolem_data::translation::bedrock::COMMANDS_UNBAN_SUCCESS,
        ...
        if successes > 0 {
            ...
            Err(CommandError::CommandFailed(TextComponent::translate_cross(
                verdantgolem_data::translation::java::COMMANDS_PARDON_FAILED,
                verdantgolem_data::translation::bedrock::COMMANDS_UNBAN_FAILED,
