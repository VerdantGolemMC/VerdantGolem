...
use verdantgolem_data::block_properties::EastWall;
use verdantgolem_data::block_properties::HorizontalFacing;
use verdantgolem_data::block_properties::NorthWall;
use verdantgolem_data::block_properties::SouthWall;
use verdantgolem_data::block_properties::WestWall;
...
type FenceGateProperties = verdantgolem_data::block_properties::OakFenceGateLikeProperties;
type FenceLikeProperties = verdantgolem_data::block_properties::OakFenceLikeProperties;
type WallProperties = verdantgolem_data::block_properties::ResinBrickWallLikeProperties;
