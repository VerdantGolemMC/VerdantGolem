...
use verdantgolem_data::{Block, FacingExt, HorizontalFacingExt};
use verdantgolem_data::{BlockDirection, BlockId};
use verdantgolem_util::math::position::BlockPos;
use verdantgolem_world::world::BlockAccessor;

type WallTorchProps = verdantgolem_data::block_properties::WallTorchLikeProperties;
