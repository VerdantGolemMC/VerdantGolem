...
use verdantgolem_data::{Block, BlockDirection, BlockStateId, tag, translation};
use verdantgolem_inventory::lectern_screen_handler::{LecternController, LecternScreenHandler};
...
impl BlockBehaviour for LecternBlock {
    ...
    fn normal_use(&self, args: NormalUseArgs<'_>) -> BlockActionResult {
        ...
        args.player.increment_stat(
            ...
            verdantgolem_data::statistic::CustomStatistic::InteractWithLectern as i32,
            1,
        );
