...
pub(crate) type PistonProps = verdantgolem_data::block_properties::StickyPistonLikeProperties;
...
impl PistonBlock {
    ...
    pub fn is_movable(
        ...
        match state.piston_behavior {
            verdantgolem_data::block_state::PistonBehavior::Destroy => return can_break,
            verdantgolem_data::block_state::PistonBehavior::Block => return false,
            verdantgolem_data::block_state::PistonBehavior::PushOnly => return dir == piston_dir,
            _ => {}
        }
