...
use verdantgolem_data::block_properties::DoorHinge;
use verdantgolem_data::block_properties::DoubleBlockHalf;
...
type DoorProperties = verdantgolem_data::block_properties::OakDoorLikeProperties;
