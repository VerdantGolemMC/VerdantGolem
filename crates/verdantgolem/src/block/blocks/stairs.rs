...
use verdantgolem_data::block_properties::Half;
use verdantgolem_data::block_properties::HorizontalFacing;
use verdantgolem_data::block_properties::StairsShape;
use verdantgolem_data::tag::Taggable;
use verdantgolem_data::{Block, BlockDirection, BlockState, BlockStateId, Mirror, Rotation, tag};
...
type StairsProperties = verdantgolem_data::block_properties::OakStairsLikeProperties;
