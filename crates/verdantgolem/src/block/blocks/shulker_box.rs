...
use verdantgolem_inventory::generic_container_screen_handler::create_generic_9x3;
...
type EndRodLikeProperties = verdantgolem_data::block_properties::EndRodLikeProperties;
    ...
    fn normal_use(&self, args: NormalUseArgs<'_>) -> BlockActionResult {
            ...
            && let Some(inventory) = block_entity.get_inventory()
        {
            args.player.increment_stat(
                ...
                verdantgolem_data::statistic::CustomStatistic::OpenShulkerBox as i32,
                1,
            );
            args.player
