...
use verdantgolem_util::math::{boundingbox::BoundingBox, position::BlockPos};
...
type TripwireProperties = verdantgolem_data::block_properties::TripwireLikeProperties;
type TripwireHookProperties = verdantgolem_data::block_properties::TripwireHookLikeProperties;
