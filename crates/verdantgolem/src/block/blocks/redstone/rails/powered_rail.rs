...
impl PoweredRailBlock {
    fn is_powered_by_other_rails(
        ...
        match next_shape {
            verdantgolem_data::block_properties::RailShape::NorthSouth => {
                if direction {
                    z += 1;
                } else {
                    z -= 1;
            ...
            verdantgolem_data::block_properties::RailShape::EastWest => {
                if direction {
                    x -= 1;
                } else {
                    x += 1;
            ...
            verdantgolem_data::block_properties::RailShape::AscendingEast => {
                if direction {
                    x -= 1;
                } else {
                    x += 1;
                ...
                next_shape = verdantgolem_data::block_properties::RailShape::EastWest;
            }
            verdantgolem_data::block_properties::RailShape::AscendingWest => {
                if direction {
                    x -= 1;
                    y += 1;
                    check_down = false;
            ...
            verdantgolem_data::block_properties::RailShape::AscendingNorth => {
                if direction {
                    z += 1;
                } else {
                    z -= 1;
                ...
                next_shape = verdantgolem_data::block_properties::RailShape::NorthSouth;
            }
            verdantgolem_data::block_properties::RailShape::AscendingSouth => {
                if direction {
                    z += 1;
                    y += 1;
                    check_down = false;
    ...
    fn update_rail_at_position(
        ...
        let shapes_compatible = match expected_shape {
            verdantgolem_data::block_properties::RailShape::EastWest => !matches!(
                rail_shape,
                verdantgolem_data::block_properties::RailShape::NorthSouth
                    | verdantgolem_data::block_properties::RailShape::AscendingNorth
                    | verdantgolem_data::block_properties::RailShape::AscendingSouth
            ),
            verdantgolem_data::block_properties::RailShape::NorthSouth => !matches!(
                rail_shape,
                verdantgolem_data::block_properties::RailShape::EastWest
                    | verdantgolem_data::block_properties::RailShape::AscendingEast
                    | verdantgolem_data::block_properties::RailShape::AscendingWest
