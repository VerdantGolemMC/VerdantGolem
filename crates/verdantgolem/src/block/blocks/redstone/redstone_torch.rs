...
type RWallTorchProps = verdantgolem_data::block_properties::FurnaceLikeProperties;
type RTorchProps = verdantgolem_data::block_properties::RedstoneOreLikeProperties;
