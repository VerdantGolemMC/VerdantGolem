...
use verdantgolem_data::block_properties::{AttachFace, BellAttachment, BellLikeProperties};
...
use verdantgolem_data::{HorizontalFacingExt, tag};
...
impl BlockBehaviour for BellBlock {
    ...
    fn normal_use(&self, args: NormalUseArgs<'_>) -> BlockActionResult {
        ...
        args.player.increment_stat(
            ...
            verdantgolem_data::statistic::CustomStatistic::BellRing as i32,
            1,
        );
