...
type CopperBulbLikeProperties = verdantgolem_data::block_properties::CopperBulbLikeProperties;

pub struct CopperBulbBlock;

impl ChangeOverTimeBlock<WeatherState> for CopperBulbBlock {
    fn get_age(&self, block: &verdantgolem_data::Block) -> Option<WeatherState> {
