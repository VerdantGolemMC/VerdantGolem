...
use verdantgolem_data::block_properties::BedPart;
...
impl BedBlock {
    ...
    fn use_bed(
        ...
        if player.set_respawn_point(
            ...
            player.send_system_message(&verdantgolem_macros::translate_cross!(
        ...
        player.increment_stat(
            ...
            verdantgolem_data::statistic::CustomStatistic::SleepInBed as i32,
            1,
        );
