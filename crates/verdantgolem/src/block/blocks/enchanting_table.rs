...
use verdantgolem_inventory::enchanting::enchanting_screen_handler::EnchantingTableScreenHandler;
...
use verdantgolem_world::inventory::{Inventory, SimpleInventory};
