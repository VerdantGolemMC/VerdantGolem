...
use verdantgolem_data::block_properties::{BlockProperties, Facing, LadderLikeProperties};
use verdantgolem_data::{Block, BlockDirection, FacingExt, HorizontalFacingExt};
