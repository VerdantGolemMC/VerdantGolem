...
use verdantgolem_data::{BlockDirection, BlockStateId};
use verdantgolem_macros::pumpkin_block;
use verdantgolem_util::{GameMode, PermissionLvl};
...
impl BlockBehaviour for JigsawBlock {
    ...
    fn mirror(
        ...
        if mirror == Mirror::None {
            return verdantgolem_data::BlockState::from_id(state_id);
        }
        ...
        verdantgolem_data::BlockState::from_id(props.to_state_id(block))
    }
