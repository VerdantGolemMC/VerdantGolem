...
use verdantgolem_data::{Block, BlockDirection, BlockId, BlockState};
...
impl BlockRegistry {
    ...
    fn entity_blocks_block_placement(entity: &dyn EntityBase) -> bool {
        ...
        entity_type == &verdantgolem_data::entity::EntityType::END_CRYSTAL
            || entity_type == &verdantgolem_data::entity::EntityType::FALLING_BLOCK
            || entity_type == &verdantgolem_data::entity::EntityType::TNT
    ...
    pub fn place_block(
        ...
        match player.gamemode.load() {
            verdantgolem_util::GameMode::Spectator | verdantgolem_util::GameMode::Adventure => {
        ...
        if location.0.y + face.to_offset().y > world.get_top_y() {
            player.send_system_message_raw(
                &verdantgolem_util::text::TextComponent::translate_cross(
                    verdantgolem_data::translation::java::BUILD_TOOHIGH,
                    verdantgolem_data::translation::bedrock::BUILD_TOOHIGH,
                    vec![verdantgolem_util::text::TextComponent::text(
        ...
        let replace_clicked_block = if clicked_block == placed_block {
            ...
            if clicked_block == &Block::WATER {
                use verdantgolem_data::block_properties::{BlockProperties, WaterLikeProperties};
                let water_props =
