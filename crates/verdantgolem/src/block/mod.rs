...
use verdantgolem_util::random::{RandomGenerator, get_seed, xoroshiro128::Xoroshiro};
...
pub fn calculate_comparator_output(inventory: &dyn verdantgolem_world::inventory::Inventory) -> u8 {
