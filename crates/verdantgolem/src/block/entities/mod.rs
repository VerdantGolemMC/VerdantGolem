...
use verdantgolem_data::{Block, block_properties::BLOCK_ENTITY_TYPES};
...
pub use verdantgolem_world::block::entities::PropertyDelegate;
...
pub fn create_block_entity(
    ...
    use verdantgolem_data::block_properties::FacingHopper;
