...
impl BedrockClient {
    ...
    pub async fn try_handle_login(
        ...
        let player_data = if server.advanced_config.networking.bedrock.online_mode {
            ...
            verdantgolem_util::jwt::extract_oidc_token_player_claims(&auth_payload.token)?
        };
        ...
        let payload_bytes = verdantgolem_util::jwt::decode_b64_url_nopad(payload_b64)
        ...
        let login_public_key = verdantgolem_util::jwt::extract_cpk_from_token(&auth_payload.token)
