        ...
        if version.supports_configuration_state() {
            ...
            if !sent_dimension_type {
                let dims = [
                    ...
                    &verdantgolem_data::dimension::Dimension::OVERWORLD_CAVES,
                    &verdantgolem_data::dimension::Dimension::THE_END,
                    &verdantgolem_data::dimension::Dimension::THE_NETHER,
                ];
                let dim_entries: Vec<verdantgolem_data::registry::RegistryEntryData> = dims
                    .iter()
                    .map(|dim| verdantgolem_data::registry::RegistryEntryData {
