...
impl PendingConnection {
    ...
    async fn handle_login_packet(
        ...
        match packet.id {
            id if id == verdantgolem_protocol::java::server::login::SLoginStart::to_id(version) => {
                Ok(self
                    .handle_login_start(
                        server,
                        verdantgolem_protocol::java::server::login::SLoginStart::read(
                            &mut payload,
                            &version,
                        )?,
                    )
                ...
                == verdantgolem_protocol::java::server::login::SEncryptionResponse::to_id(version) =>
            {
                Ok(self
                    .handle_encryption_response(
                        server,
                        verdantgolem_protocol::java::server::login::SEncryptionResponse::read(
                            &mut payload,
                            &version,
                        )?,
                    )
                ...
                == verdantgolem_protocol::java::server::login::SLoginPluginResponse::to_id(version) =>
            {
                Ok(self
                    .handle_plugin_response(
                        server,
                        verdantgolem_protocol::java::server::login::SLoginPluginResponse::read(
                            &mut payload,
                            &version,
                        )?,
                    )
    ...
    pub async fn handle_resource_pack_response(
        ...
        if resource_config.enabled {
            use verdantgolem_protocol::java::server::config::ResourcePackResponseResult;
