            ...
            let label = match &l.label {
                LinkLabel::BuiltIn(t) => {
                    let link_type = match t {
                        LinkType::BugReport => verdantgolem_protocol::LinkType::BugReport,
                        LinkType::CommunityGuidelines => {
                            verdantgolem_protocol::LinkType::CommunityGuidelines
                        }
                        LinkType::Support => verdantgolem_protocol::LinkType::Support,
                        LinkType::Status => verdantgolem_protocol::LinkType::Status,
                        LinkType::Feedback => verdantgolem_protocol::LinkType::Feedback,
                        LinkType::Community => verdantgolem_protocol::LinkType::Community,
                        LinkType::Website => verdantgolem_protocol::LinkType::Website,
                        LinkType::Forums => verdantgolem_protocol::LinkType::Forums,
                        LinkType::News => verdantgolem_protocol::LinkType::News,
                        LinkType::Announcements => verdantgolem_protocol::LinkType::Announcements,
                    };
                    verdantgolem_protocol::Label::BuiltIn(link_type)
                }
                LinkLabel::Custom(c) => verdantgolem_protocol::Label::TextComponent(Box::new(
...
pub(crate) fn protocol_dialog_to_wasm(
    ...
    let links = dialog
        ...
        .map(|l| {
            let label = match &l.label {
                verdantgolem_protocol::Label::BuiltIn(t) => LinkLabel::BuiltIn(match t {
                    verdantgolem_protocol::LinkType::BugReport => LinkType::BugReport,
                    verdantgolem_protocol::LinkType::CommunityGuidelines => {
                        LinkType::CommunityGuidelines
                    }
                    verdantgolem_protocol::LinkType::Support => LinkType::Support,
                    verdantgolem_protocol::LinkType::Status => LinkType::Status,
                    verdantgolem_protocol::LinkType::Feedback => LinkType::Feedback,
                    verdantgolem_protocol::LinkType::Community => LinkType::Community,
                    verdantgolem_protocol::LinkType::Website => LinkType::Website,
                    verdantgolem_protocol::LinkType::Forums => LinkType::Forums,
                    verdantgolem_protocol::LinkType::News => LinkType::News,
                    verdantgolem_protocol::LinkType::Announcements => LinkType::Announcements,
                }),
                verdantgolem_protocol::Label::TextComponent(c) => {
                    let comp = state
