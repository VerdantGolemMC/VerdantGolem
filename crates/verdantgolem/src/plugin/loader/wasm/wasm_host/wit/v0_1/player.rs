...
use verdantgolem_util::version::{BedrockMinecraftVersion, JavaMinecraftVersion};
...
pub const fn to_wit_statistic_category(
    category: verdantgolem_data::statistic::StatisticCategory,
) -> WitStatisticCategory {
    match category {
        verdantgolem_data::statistic::StatisticCategory::Mined => WitStatisticCategory::Mined,
        verdantgolem_data::statistic::StatisticCategory::Crafted => WitStatisticCategory::Crafted,
        verdantgolem_data::statistic::StatisticCategory::Used => WitStatisticCategory::Used,
        verdantgolem_data::statistic::StatisticCategory::Broken => WitStatisticCategory::Broken,
        verdantgolem_data::statistic::StatisticCategory::PickedUp => WitStatisticCategory::PickedUp,
        verdantgolem_data::statistic::StatisticCategory::Dropped => WitStatisticCategory::Dropped,
        verdantgolem_data::statistic::StatisticCategory::Killed => WitStatisticCategory::Killed,
        verdantgolem_data::statistic::StatisticCategory::KilledBy => WitStatisticCategory::KilledBy,
        verdantgolem_data::statistic::StatisticCategory::Custom => WitStatisticCategory::Custom,
    }
}
...
) -> verdantgolem_data::statistic::StatisticCategory {
    match wit {
        WitStatisticCategory::Mined => verdantgolem_data::statistic::StatisticCategory::Mined,
        WitStatisticCategory::Crafted => verdantgolem_data::statistic::StatisticCategory::Crafted,
        WitStatisticCategory::Used => verdantgolem_data::statistic::StatisticCategory::Used,
        WitStatisticCategory::Broken => verdantgolem_data::statistic::StatisticCategory::Broken,
        WitStatisticCategory::PickedUp => verdantgolem_data::statistic::StatisticCategory::PickedUp,
        WitStatisticCategory::Dropped => verdantgolem_data::statistic::StatisticCategory::Dropped,
        WitStatisticCategory::Killed => verdantgolem_data::statistic::StatisticCategory::Killed,
        WitStatisticCategory::KilledBy => verdantgolem_data::statistic::StatisticCategory::KilledBy,
        WitStatisticCategory::Custom => verdantgolem_data::statistic::StatisticCategory::Custom,
    }
}

#[must_use]
pub const fn to_wit_custom_statistic(
    stat: verdantgolem_data::statistic::CustomStatistic,
) -> WitCustomStatistic {
...
) -> verdantgolem_data::statistic::CustomStatistic {
    verdantgolem_data::statistic::CustomStatistic::from_i32(wit as i32)
        .unwrap_or(verdantgolem_data::statistic::CustomStatistic::PlayTime)
}
...
) -> verdantgolem_protocol::bedrock::client::update_abilities::Ability {
    match ability {
        pumpkin::plugin::player::BedrockAbility::Build => {
            verdantgolem_protocol::bedrock::client::update_abilities::Ability::Build
        }
        pumpkin::plugin::player::BedrockAbility::Mine => {
            verdantgolem_protocol::bedrock::client::update_abilities::Ability::Mine
        }
        pumpkin::plugin::player::BedrockAbility::DoorsAndSwitches => {
            verdantgolem_protocol::bedrock::client::update_abilities::Ability::DoorsAndSwitches
        }
        pumpkin::plugin::player::BedrockAbility::OpenContainers => {
            verdantgolem_protocol::bedrock::client::update_abilities::Ability::OpenContainers
        }
        pumpkin::plugin::player::BedrockAbility::AttackPlayers => {
            verdantgolem_protocol::bedrock::client::update_abilities::Ability::AttackPlayers
        }
        pumpkin::plugin::player::BedrockAbility::AttackMobs => {
            verdantgolem_protocol::bedrock::client::update_abilities::Ability::AttackMobs
        }
        pumpkin::plugin::player::BedrockAbility::OperatorCommands => {
            verdantgolem_protocol::bedrock::client::update_abilities::Ability::OperatorCommands
        }
        pumpkin::plugin::player::BedrockAbility::Teleport => {
            verdantgolem_protocol::bedrock::client::update_abilities::Ability::Teleport
        }
        pumpkin::plugin::player::BedrockAbility::Invulnerable => {
            verdantgolem_protocol::bedrock::client::update_abilities::Ability::Invulnerable
        }
        pumpkin::plugin::player::BedrockAbility::Flying => {
            verdantgolem_protocol::bedrock::client::update_abilities::Ability::Flying
        }
        pumpkin::plugin::player::BedrockAbility::MayFly => {
            verdantgolem_protocol::bedrock::client::update_abilities::Ability::MayFly
        }
        pumpkin::plugin::player::BedrockAbility::Instabuild => {
            verdantgolem_protocol::bedrock::client::update_abilities::Ability::Instabuild
        }
        pumpkin::plugin::player::BedrockAbility::Lightning => {
            verdantgolem_protocol::bedrock::client::update_abilities::Ability::Lightning
        }
        pumpkin::plugin::player::BedrockAbility::FlySpeed => {
            verdantgolem_protocol::bedrock::client::update_abilities::Ability::FlySpeed
        }
        pumpkin::plugin::player::BedrockAbility::WalkSpeed => {
            verdantgolem_protocol::bedrock::client::update_abilities::Ability::WalkSpeed
        }
        pumpkin::plugin::player::BedrockAbility::Muted => {
            verdantgolem_protocol::bedrock::client::update_abilities::Ability::Muted
        }
        pumpkin::plugin::player::BedrockAbility::WorldBuilder => {
            verdantgolem_protocol::bedrock::client::update_abilities::Ability::WorldBuilder
        }
        pumpkin::plugin::player::BedrockAbility::NoClip => {
            verdantgolem_protocol::bedrock::client::update_abilities::Ability::NoClip
        }
        pumpkin::plugin::player::BedrockAbility::PrivilegedBuilder => {
            verdantgolem_protocol::bedrock::client::update_abilities::Ability::PrivilegedBuilder
        }
        pumpkin::plugin::player::BedrockAbility::VerticalFlySpeed => {
            verdantgolem_protocol::bedrock::client::update_abilities::Ability::VerticalFlySpeed
        }
    }
}
...
const fn from_wasm_bedrock_status_flag(flag: pumpkin::plugin::player::BedrockStatusFlag) -> u32 {
    use verdantgolem_protocol::bedrock::client::set_actor_data::entity_data_flag;
    match flag {
...
) -> verdantgolem_util::text::TextComponent {
    state
        .resource_table
...
use verdantgolem_inventory::generic_container_screen_handler::GenericContainerScreenHandler;
...
use verdantgolem_protocol::java::client::play::CSetContainerSlot;
...
impl pumpkin::plugin::player::HostPlayer for PluginHostState {
    async fn set_item_in_hand(
        ...
        let slot = match hand {
            verdantgolem_util::Hand::Right => player.inventory().get_selected_slot() as usize,
            verdantgolem_util::Hand::Left => PlayerInventory::OFF_HAND_SLOT,
        };
    ...
    async fn clear_ender_chest(&mut self, player: Resource<Player>) -> wasmtime::Result<()> {
        ...
        if let Some(sync_id) = sync_id {
            let empty_serializer =
                ItemStackSerializer::from(verdantgolem_data::item_stack::ItemStack::EMPTY.clone());
            for slot in 0..27 {
                let packet =
    ...
    async fn add_effect(
        ...
        if let Some(status_effect) =
            verdantgolem_data::effect::StatusEffect::from_name(effect_type.to_name())
        {
            let effect_obj = verdantgolem_data::potion::Effect {
    ...
    async fn set_compass_target(
        ...
        let block_pos = verdantgolem_util::math::position::BlockPos::new(
            pos_vec.x as i32,
            pos_vec.y as i32,
            pos_vec.z as i32,
        );
    ...
    > {
        ...
        let target = player
            .get_compass_target()
            .unwrap_or(verdantgolem_util::math::position::BlockPos::new(0, 0, 0));
        let vec3 = verdantgolem_util::math::vector3::Vector3::new(
            f64::from(target.0.x),
            f64::from(target.0.y),
            f64::from(target.0.z),
        );
    ...
    async fn open_gui(
        ...
        let screen_handler: Arc<
            std::sync::Mutex<dyn verdantgolem_inventory::screen_handler::ScreenHandler>,
    ...
    async fn transfer(
        ...
        if let crate::net::ClientPlatform::Java(client) = player.client.as_ref() {
            client
                .send_packet(&verdantgolem_protocol::java::client::play::CTransfer::new(
                    &host,
                    verdantgolem_protocol::codec::var_int::VarInt(i32::from(port)),
                ))
                .await;
        }
        Ok(())
...
impl pumpkin::plugin::player::HostJavaPlayer for PluginHostState {
    ...
    async fn get_settings(
        ...
        Ok(pumpkin::plugin::player::JavaPlayerSettings {
            ...
            main_hand: match config.main_hand {
                verdantgolem_util::Hand::Left => pumpkin::plugin::common::Hand::Left,
                verdantgolem_util::Hand::Right => pumpkin::plugin::common::Hand::Right,
            },
    ...
    async fn show_dialog(
        ...
        if let crate::net::ClientPlatform::Java(client) = player.client.as_ref() {
            match client.connection_state.load() {
                verdantgolem_protocol::ConnectionState::Config => {
                    client
                        .send_packet(
                            &verdantgolem_protocol::java::client::config::CConfigShowDialog::new(
        ...
        if let crate::net::ClientPlatform::Java(client) = player.client.as_ref() {
            match client.connection_state.load() {
                verdantgolem_protocol::ConnectionState::Config => {
                    client
                        .send_packet(
                            &verdantgolem_protocol::java::client::config::CConfigClearDialog::new(),
                        )
                        .await;
                }
                verdantgolem_protocol::ConnectionState::Play => {
    ...
    async fn send_resource_pack(
        ...
        if let crate::net::ClientPlatform::Java(client) = player.client.as_ref() {
            client
                .send_packet(
                    &verdantgolem_protocol::java::client::play::CAddResourcePack::new(
                        &uuid,
                        &pack.url,
                        &pack.hash,
                        pack.forced,
...
impl pumpkin::plugin::player::HostBedrockPlayer for PluginHostState {
        ...
        if let crate::net::ClientPlatform::Bedrock(client) = player.client.as_ref() {
            ...
            client
                .send_packet(&CModalFormRequest {
                    form_id: verdantgolem_protocol::codec::var_uint::VarUInt(form_id),
    ...
    async fn send_resource_packs_info(
        ...
        if let crate::net::ClientPlatform::Bedrock(client) = player.client.as_ref() {
            ...
            let packs_info =
                verdantgolem_protocol::bedrock::client::resource_packs_info::CResourcePacksInfo {
