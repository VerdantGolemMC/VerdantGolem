...
impl pumpkin::plugin::context::HostContext for PluginHostState {
    ...
    async fn register_permission(
        ...
        let util_permission = verdantgolem_util::permission::Permission {
            node: permission.node,
            description: permission.description,
            default: match permission.default {
                PermissionDefault::Deny => verdantgolem_util::permission::PermissionDefault::Deny,
                PermissionDefault::Allow => verdantgolem_util::permission::PermissionDefault::Allow,
                PermissionDefault::Op(lvl) => {
                    verdantgolem_util::permission::PermissionDefault::Op(match lvl {
