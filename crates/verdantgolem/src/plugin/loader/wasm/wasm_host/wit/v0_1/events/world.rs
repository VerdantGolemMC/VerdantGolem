    ...
    fn from_wasm_event(event: Event, state: &mut PluginHostState) -> Self {
        match event {
            Event::ChunkLoadEvent(data) => {
                ...
                let chunk_data = verdantgolem_world::chunk::ChunkData {
                    section: verdantgolem_world::chunk::ChunkSections::new(24, -64),
                    heightmap: std::sync::Mutex::new(
                        verdantgolem_world::chunk::ChunkHeightmaps::default(),
                    ),
                    x: data.chunk_x,
                    z: data.chunk_z,
                    block_ticks: verdantgolem_world::tick::scheduler::ChunkTickScheduler::default(),
                    fluid_ticks: verdantgolem_world::tick::scheduler::ChunkTickScheduler::default(),
    ...
    fn from_wasm_event(event: Event, _state: &mut PluginHostState) -> Self {
        match event {
            Event::GenericGameEvent(data) => Self {
                ...
                position: verdantgolem_util::math::vector3::Vector3::new(
