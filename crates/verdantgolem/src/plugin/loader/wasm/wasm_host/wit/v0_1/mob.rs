...
pub const fn to_wit_villager_profession(prof_id: i32) -> WitVillagerProfession {
    let prof = match verdantgolem_data::villager::VillagerProfession::from_i32(prof_id) {
        Some(p) => p,
        None => verdantgolem_data::villager::VillagerProfession::None,
    };
    match prof {
        verdantgolem_data::villager::VillagerProfession::None => WitVillagerProfession::None,
        verdantgolem_data::villager::VillagerProfession::Armorer => WitVillagerProfession::Armorer,
        verdantgolem_data::villager::VillagerProfession::Butcher => WitVillagerProfession::Butcher,
        verdantgolem_data::villager::VillagerProfession::Cartographer => {
...
) -> verdantgolem_data::villager::VillagerProfession {
    match prof {
        WitVillagerProfession::None => verdantgolem_data::villager::VillagerProfession::None,
        WitVillagerProfession::Armorer => verdantgolem_data::villager::VillagerProfession::Armorer,
        WitVillagerProfession::Butcher => verdantgolem_data::villager::VillagerProfession::Butcher,
        WitVillagerProfession::Cartographer => {
            verdantgolem_data::villager::VillagerProfession::Cartographer
        }
...
#[must_use]
pub const fn to_wit_block_direction(dir: verdantgolem_data::BlockDirection) -> WitBlockDirection {
    match dir {
        verdantgolem_data::BlockDirection::Down => WitBlockDirection::Down,
        verdantgolem_data::BlockDirection::Up => WitBlockDirection::Up,
        verdantgolem_data::BlockDirection::North => WitBlockDirection::North,
        verdantgolem_data::BlockDirection::South => WitBlockDirection::South,
        verdantgolem_data::BlockDirection::West => WitBlockDirection::West,
        verdantgolem_data::BlockDirection::East => WitBlockDirection::East,
    }
}

#[must_use]
pub const fn from_wit_block_direction(dir: WitBlockDirection) -> verdantgolem_data::BlockDirection {
    match dir {
        WitBlockDirection::Down => verdantgolem_data::BlockDirection::Down,
        WitBlockDirection::Up => verdantgolem_data::BlockDirection::Up,
        WitBlockDirection::North => verdantgolem_data::BlockDirection::North,
        WitBlockDirection::South => verdantgolem_data::BlockDirection::South,
        WitBlockDirection::West => verdantgolem_data::BlockDirection::West,
        WitBlockDirection::East => verdantgolem_data::BlockDirection::East,
    }
}
            ...
            match goal {
                ...
                crate::plugin::loader::wasm::wasm_host::wit::v0_1::pumpkin::plugin::world::BuiltinAiGoal::LookAtPlayer(range) => {
                    mob_entity.add_goal(priority, crate::entity::ai::goal::look_at_entity::LookAtEntityGoal::new(
                        ...
                        &verdantgolem_data::entity::EntityType::PLAYER,
                        range,
                        0.02,
                        false,
                    ));
        ...
        if let Some(enderman) = any.downcast_ref::<crate::entity::mob::enderman::EndermanEntity>() {
            return Ok(WitMobData::Enderman(WitEndermanData {
                carried_block_state: enderman
                    .get_carried_block()
                    .map(verdantgolem_data::BlockStateId::as_u16),
                ...
                {
                    {
                        let mut vdata = villager
                            ...
                            .lock()
                            .unwrap_or_else(std::sync::PoisonError::into_inner);
                        vdata.profession = verdantgolem_protocol::codec::var_int::VarInt(
                            from_wit_villager_profession(villager_data.profession) as i32,
                        );
                        vdata.level = verdantgolem_protocol::codec::var_int::VarInt(i32::from(
                            villager_data.level,
                        ));
                    };
                    villager.xp.store(
            ...
            WitMobData::Enderman(enderman_data) => {
                    ...
                    any.downcast_ref::<crate::entity::mob::enderman::EndermanEntity>()
                {
                    enderman.set_carried_block(
                        enderman_data
                            .carried_block_state
                            .and_then(verdantgolem_data::BlockStateId::new),
                    );
