...
impl gui::HostGui for PluginHostState {
    async fn new(
        ...
        let size = match window_type {
            verdantgolem_data::screen::WindowType::Generic9x2 => 18,
            verdantgolem_data::screen::WindowType::Generic9x4 => 36,
            verdantgolem_data::screen::WindowType::Generic9x5 => 45,
            verdantgolem_data::screen::WindowType::Generic9x6 => 54,
            verdantgolem_data::screen::WindowType::Generic3x3 => 9,
            verdantgolem_data::screen::WindowType::Generic9x1
            | verdantgolem_data::screen::WindowType::Hopper => 5,
            _ => 27, // Default
        };
