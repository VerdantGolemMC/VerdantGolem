...
impl scoreboard::HostScoreboard for PluginHostState {
    async fn add_objective(
        ...
        let rt = match render_type {
            RenderType::Integer => verdantgolem_protocol::java::client::play::RenderType::Integer,
            RenderType::Hearts => verdantgolem_protocol::java::client::play::RenderType::Hearts,
        };
...
const fn map_display_slot(slot: DisplaySlot) -> verdantgolem_data::scoreboard::ScoreboardDisplaySlot {
    match slot {
        ...
        DisplaySlot::SidebarTeamDarkGreen => {
            verdantgolem_data::scoreboard::ScoreboardDisplaySlot::TeamDarkGreen
        }
        DisplaySlot::SidebarTeamDarkAqua => {
            verdantgolem_data::scoreboard::ScoreboardDisplaySlot::TeamDarkAqua
        }
        DisplaySlot::SidebarTeamDarkRed => {
            verdantgolem_data::scoreboard::ScoreboardDisplaySlot::TeamDarkRed
        }
...
const fn map_named_color(
    ...
    match color {
        ...
        pumpkin::plugin::common::NamedColor::DarkGreen => {
            verdantgolem_util::text::color::NamedColor::DarkGreen
        }
        pumpkin::plugin::common::NamedColor::DarkAqua => {
            verdantgolem_util::text::color::NamedColor::DarkAqua
        }
        pumpkin::plugin::common::NamedColor::DarkRed => {
            verdantgolem_util::text::color::NamedColor::DarkRed
        }
