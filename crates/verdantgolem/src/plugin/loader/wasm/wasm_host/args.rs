...
pub enum OwnedArg {
    ...
    BlockPos(verdantgolem_util::math::position::BlockPos),
    Pos3D(verdantgolem_util::math::vector3::Vector3<f64>),
    Pos2D(verdantgolem_util::math::vector2::Vector2<f64>),
    Rotation(f32, bool, f32, bool),
    GameMode(verdantgolem_util::GameMode),
    Difficulty(verdantgolem_util::Difficulty),
    ...
    Bool(bool),
    Simple(String),
    SoundCategory(verdantgolem_data::sound::SoundCategory),
    DamageType(verdantgolem_data::damage::DamageType),
    Effect(&'static verdantgolem_data::effect::StatusEffect),
    Enchantment(&'static verdantgolem_data::Enchantment),
    EntityAnchor(crate::command::args::EntityAnchor),
    Advancement(&'static verdantgolem_data::Advancement),
}
