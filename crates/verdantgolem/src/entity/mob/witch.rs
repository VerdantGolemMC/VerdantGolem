...
use verdantgolem_data::potion::Potion;
...
impl Mob for WitchEntity {
    ...
    fn mob_write_nbt(&self, nbt: &mut verdantgolem_nbt::compound::NbtCompound) {
        self.write_raider_nbt(nbt);
    }

    fn mob_read_nbt(&self, nbt: &verdantgolem_nbt::compound::NbtCompound) {
