...
impl HappyGhastEntity {
    ...
    fn set_leash_holder(&self, is_leash_holder: bool) {
        ...
        entity.send_meta_data(
            &[Metadata::new(
                verdantgolem_data::tracked_data::happy_ghast::IS_LEASH_HOLDER,
                is_leash_holder,
            )],
            None,
        );
    ...
    fn sync_stay_still_flag(&self) {
        ...
        entity.send_meta_data(
            &[Metadata::new(
                verdantgolem_data::tracked_data::happy_ghast::STAYS_STILL,
                stays_still,
            )],
            None,
        );
...
impl Mob for HappyGhastEntity {
    ...
    fn mob_init_data_tracker(&self) {
        ...
        if is_baby {
            entity.send_meta_data(
                &[Metadata::new(
                    verdantgolem_data::tracked_data::happy_ghast::BABY_ID,
                    true,
                )],
                None,
            );
