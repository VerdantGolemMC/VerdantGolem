...
use verdantgolem_protocol::bedrock::client::CAddItemActor;
use verdantgolem_protocol::bedrock::network_item::ItemStackWrapper;
...
impl ItemEntity {
    ...
    pub fn new_empty(entity: Entity) -> Self {
        Self {
            entity,
            item_stack: Mutex::new(ItemStack::new(1, &verdantgolem_data::item::Item::AIR)),
            item_age: AtomicU32::new(0),
...
impl EntityBase for ItemEntity {
    ...
    fn init_data_tracker(&self) {
        self.entity.send_meta_data(
            &[Metadata::new(
                verdantgolem_data::tracked_data::item::ITEM,
