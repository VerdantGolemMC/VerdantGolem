    ...
    pub fn reel_in(&self, player: &Player) -> i32 {
        ...
        if self.bite_countdown.load(Ordering::Relaxed) > 0 {
            ...
            player.increment_stat(
                ...
                verdantgolem_data::statistic::CustomStatistic::FishCaught as i32,
                1,
            );
            ...
            if bite > 0 {
                ...
                if bite % 5 == 0 {
                    world.spawn_particle(
                        ...
                        0.0,
                        5,
                        verdantgolem_data::particle::Particle::Bubble,
                    );
                }
            } else {
        ...
        for cand in candidates {
            ...
            if ebb.intersects(&search_box) {
                ...
                entity.send_meta_data(
                    &[Metadata::new(
                        verdantgolem_data::tracked_data::fishing_bobber::HOOKED_ENTITY,
