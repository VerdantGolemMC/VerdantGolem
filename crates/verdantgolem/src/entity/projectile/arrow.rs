...
use verdantgolem_protocol::java::client::play::CSoundEffect;
...
impl ArrowEntity {
    ...
    fn read_item_stack_nbt(nbt: &verdantgolem_nbt::compound::NbtCompound) -> Option<ItemStack> {
    ...
    const fn spectral_glowing_effect() -> verdantgolem_data::potion::Effect {
        verdantgolem_data::potion::Effect {
            effect_type: &verdantgolem_data::effect::StatusEffect::GLOWING,
            duration: 200,
            amplifier: 0,
            ambient: false,
            show_particles: true,
...
impl EntityBase for ArrowEntity {
    fn write_custom_nbt(&self, nbt: &mut verdantgolem_nbt::compound::NbtCompound) {
        let item_stack = self
            .item_stack
            .read()
    ...
    fn read_custom_nbt(&self, nbt: &verdantgolem_nbt::compound::NbtCompound) {
        ...
        match hit {
            ProjectileHit::Block {
                ...
                *self
                ...
                if block == &verdantgolem_data::Block::TARGET
...
impl ArrowEntity {
    fn should_skip_collision(&self, self_ent: &Entity, other: &Arc<dyn EntityBase>) -> bool {
        ...
        if (other_ent.entity_type == &verdantgolem_data::entity::EntityType::ARROW
            || other_ent.entity_type == &verdantgolem_data::entity::EntityType::SPECTRAL_ARROW)
            || other_ent.entity_type == &verdantgolem_data::entity::EntityType::ITEM
            || other_ent.entity_type == &verdantgolem_data::entity::EntityType::FALLING_BLOCK
        {
            return true;
        }
...
fn get_hit_face(hit_pos: Vector3<f64>, block_pos: BlockPos) -> verdantgolem_data::BlockDirection {
...
mod tests {
    ...
    fn spectral_arrow_applies_vanilla_glowing_effect() {
        ...
        assert_eq!(
            effect.effect_type,
            &verdantgolem_data::effect::StatusEffect::GLOWING
        );
