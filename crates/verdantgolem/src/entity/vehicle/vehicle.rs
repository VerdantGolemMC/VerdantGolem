...
impl VehicleEntity {
    ...
    pub async fn move_vehicle(
        &self,
        from: verdantgolem_util::math::vector3::Vector3<f64>,
        to: verdantgolem_util::math::vector3::Vector3<f64>,
    ) {
        let mut move_event =
    ...
    pub async fn collide_block(&self, block_pos: verdantgolem_util::math::position::BlockPos) {
        let mut base_event =
            crate::plugin::api::events::vehicle::vehicle_collision::VehicleCollisionEvent::new(
                self.entity.entity_id,
            );
    ...
    pub fn send_wobble_metadata(&self) {
        self.entity.send_meta_data(
            &[
                Metadata::new(
                    verdantgolem_data::tracked_data::boat::ID_HURT,
        ...
        self.entity.send_meta_data(
            &[Metadata::new(
                verdantgolem_data::tracked_data::boat::ID_DAMAGE,
                self.get_damage(),
            )],
            None,
        );
