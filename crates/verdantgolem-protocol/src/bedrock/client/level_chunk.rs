...
impl CLevelChunk<'_> {
    pub fn encode_chunk(
        ...
        // Optional sub-chunk request limit. VerdantGolem sends complete chunks.
...
mod tests {
    ...
    use verdantgolem_data::{Block, BlockState};
    use verdantgolem_nbt::{Nbt, compound::NbtCompound, deserializer::NbtReadHelperBedrock};
