use verdantgolem_data::packet::clientbound::play::LOGIN;
use verdantgolem_util::{resource_location::ResourceLocation, version::JavaMinecraftVersion};
            ...
            if reg_name == "dimension_type" {
                ...
                for entry in &reg.registry_entries {
                    if let Some(ref data) = entry.data {
                        ...
                        if let Ok(element_nbt) = verdantgolem_nbt::Nbt::read_unnamed(&mut reader) {
    ...
    fn write_packet_data(
        ...
        if v1_16 {
            ...
            if !v1_20_2 {
                ...
                let nbt_bytes = verdantgolem_nbt::Nbt::new(String::new(), registry_codec).write();
...
mod tests {
    ...
    fn v1_20_login_packet() {
        ...
        let codec = verdantgolem_nbt::Nbt::read(&mut reader).expect("NBT codec");
