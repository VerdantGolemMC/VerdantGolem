use std::io::Write;
use verdantgolem_data::packet::clientbound::play::SECTION_BLOCKS_UPDATE;
use verdantgolem_data::{BlockStateId, block_state_remap::remap_block_state_for_version};
use verdantgolem_macros::java_packet;
use verdantgolem_util::math::position::{
    BlockPos, chunk_section_from_pos, pack_local_chunk_section,
};
use verdantgolem_util::math::vector3::{self, Vector3};
