...
impl MetadataSerializer for verdantgolem_util::text::TextComponent {
    fn write_metadata(
        &self,
        writer: &mut impl std::io::Write,
        version: &JavaMinecraftVersion,
...
impl MetadataSerializer for Option<verdantgolem_util::text::TextComponent> {
    fn write_metadata(
        &self,
        writer: &mut impl std::io::Write,
        version: &JavaMinecraftVersion,
...
impl MetadataSerializer for verdantgolem_util::math::position::BlockPos {
    fn write_metadata(
        &self,
        writer: &mut impl std::io::Write,
        version: &JavaMinecraftVersion,
...
impl MetadataSerializer for Option<verdantgolem_util::math::position::BlockPos> {
    fn write_metadata(
        &self,
        writer: &mut impl std::io::Write,
        version: &JavaMinecraftVersion,
...
mod tests {
    ...
    use verdantgolem_data::{meta_data_type::MetaDataType, particle::Particle};
    use verdantgolem_util::version::JavaMinecraftVersion;
    ...
    fn encoded_particle(version: JavaMinecraftVersion) -> (VarInt, Vec<u8>) {
        ...
        let metadata = Metadata::new(
            verdantgolem_data::tracked_data::area_effect_cloud::DATA_PARTICLE,
            ParticleMetadata {
        ...
        assert_eq!(
            bytes[0],
            verdantgolem_data::tracked_data::area_effect_cloud::DATA_PARTICLE.get(&version)
        );
