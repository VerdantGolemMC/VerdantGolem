...
use verdantgolem_data::block_entity_type_id_remap::remap_block_entity_type_id_for_version;
use verdantgolem_data::packet::clientbound::play::BLOCK_ENTITY_DATA;
use verdantgolem_macros::java_packet;
use verdantgolem_util::{math::position::BlockPos, version::JavaMinecraftVersion};
