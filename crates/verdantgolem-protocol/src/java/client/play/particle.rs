...
use verdantgolem_util::{math::vector3::Vector3, version::JavaMinecraftVersion};
...
pub fn particle_id_from_1_7_name(name: &str) -> i32 {
    match name {
        "explode" => verdantgolem_data::particle::Particle::Poof as i32,
        "largeexplode" => verdantgolem_data::particle::Particle::Explosion as i32,
        "hugeexplosion" => verdantgolem_data::particle::Particle::ExplosionEmitter as i32,
        "fireworksSpark" => verdantgolem_data::particle::Particle::Firework as i32,
        "bubble" => verdantgolem_data::particle::Particle::Bubble as i32,
        "splash" => verdantgolem_data::particle::Particle::Splash as i32,
        "wake" => verdantgolem_data::particle::Particle::Fishing as i32,
        "suspended" | "depthsuspend" => verdantgolem_data::particle::Particle::Underwater as i32,
        "crit" => verdantgolem_data::particle::Particle::Crit as i32,
        "magicCrit" => verdantgolem_data::particle::Particle::EnchantedHit as i32,
        "smoke" => verdantgolem_data::particle::Particle::Smoke as i32,
        "largesmoke" => verdantgolem_data::particle::Particle::LargeSmoke as i32,
        "spell" | "instantSpell" => verdantgolem_data::particle::Particle::InstantEffect as i32,
        "mobSpell" => verdantgolem_data::particle::Particle::EntityEffect as i32,
        "mobSpellAmbient" => verdantgolem_data::particle::Particle::Effect as i32,
        "witchMagic" => verdantgolem_data::particle::Particle::Witch as i32,
        "dripWater" => verdantgolem_data::particle::Particle::DrippingWater as i32,
        "dripLava" => verdantgolem_data::particle::Particle::DrippingLava as i32,
        "angryVillager" => verdantgolem_data::particle::Particle::AngryVillager as i32,
        "happyVillager" => verdantgolem_data::particle::Particle::HappyVillager as i32,
        "townaura" => verdantgolem_data::particle::Particle::Mycelium as i32,
        "note" => verdantgolem_data::particle::Particle::Note as i32,
        "portal" => verdantgolem_data::particle::Particle::Portal as i32,
        "enchantmenttable" => verdantgolem_data::particle::Particle::Enchant as i32,
        "flame" => verdantgolem_data::particle::Particle::Flame as i32,
        "lava" => verdantgolem_data::particle::Particle::Lava as i32,
        "cloud" => verdantgolem_data::particle::Particle::Cloud as i32,
        "reddust" => verdantgolem_data::particle::Particle::Dust as i32,
        "snowballpoof" | "snowshovel" => verdantgolem_data::particle::Particle::ItemSnowball as i32,
        "slime" => verdantgolem_data::particle::Particle::ItemSlime as i32,
        "heart" => verdantgolem_data::particle::Particle::Heart as i32,
        "barrier" => verdantgolem_data::particle::Particle::BlockMarker as i32,
        "droplet" => verdantgolem_data::particle::Particle::Rain as i32,
        _ => verdantgolem_data::particle::Particle::from_name(name).map_or(0, |p| p as i32),
    }
}
...
impl ClientPacket for CParticle<'_> {
    fn write_packet_data(
        ...
        if *version <= JavaMinecraftVersion::V_1_7_6 {
            let name = verdantgolem_data::particle::Particle::from_id(self.particle_id.0 as u16)
