...
pub struct MerchantScreenHandler {
    ...
    pub offers: Vec<verdantgolem_protocol::java::client::play::MerchantOffer>,
...
impl MerchantScreenHandler {
    pub fn new(
        ...
        offers: Vec<verdantgolem_protocol::java::client::play::MerchantOffer>,
    ) -> Self {
...
impl ScreenHandler for MerchantScreenHandler {
    ...
    fn on_slot_click(
        ...
        slot_index: i32,
        button: i32,
        action_type: verdantgolem_protocol::java::server::play::SlotActionType,
...
mod tests {
    ...
    fn single_cost_offer(
        ...
        output: &'static Item,
        max_uses: i32,
    ) -> verdantgolem_protocol::java::client::play::MerchantOffer {
        verdantgolem_protocol::java::client::play::MerchantOffer {
    ...
    fn bookshelf_offer() -> verdantgolem_protocol::java::client::play::MerchantOffer {
