...
use verdantgolem_data::{fuels::is_fuel, item::Item, statistic::StatisticCategory};
use verdantgolem_world::{block::entities::ExperienceContainer, inventory::Inventory};
...
impl Slot for FurnaceLikeSlot {
    ...
    fn can_insert(&self, stack: &verdantgolem_data::item_stack::ItemStack) -> bool {
...
impl Slot for FurnaceOutputSlot {
    ...
    fn on_take_item(
        ...
        stack: &verdantgolem_data::item_stack::ItemStack,
    ) {
    ...
    fn can_insert(&self, _stack: &verdantgolem_data::item_stack::ItemStack) -> bool {
