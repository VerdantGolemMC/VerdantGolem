//! VerdantGolem inventory system.
//!
//! This crate provides the inventory management system for the VerdantGolem Minecraft server.
...
//!
//! [`Inventory`]: verdantgolem_world::inventory::Inventory
