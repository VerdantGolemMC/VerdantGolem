...
impl ItemStack {
    ...
    pub fn set_lore(&mut self, lines: Vec<verdantgolem_util::text::TextComponent>) {
    ...
    pub fn add_lore(&mut self, line: verdantgolem_util::text::TextComponent) {
        let mut lines = self
    ...
    pub fn set_custom_name(&mut self, name: String) {
        ...
        let component = Some(
            CustomNameImpl {
                name: verdantgolem_util::text::TextComponent::text(name),
            }
            .to_dyn(),
        );
...
mod tests {
    ...
    fn custom_data_preserves_other_item_components() {
        ...
        stack.patch.push((
            ...
            Some(
                CustomNameImpl {
                    name: verdantgolem_util::text::TextComponent::text("Marked Item"),
                }
                .to_dyn(),
            ),
        ));
